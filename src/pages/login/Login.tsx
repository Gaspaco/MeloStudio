      ...
      <div class="login__stage">
        ...
        <form class="login__form" onSubmit={handleSubmit}>
          ...
          <div class="login__row">
            ...
            <a class="login__forgot" href="#" onClick={(e) => { e.preventDefault(); props.onForgot?.(); }}>Forgot password?</a>
          </div>
          ...
          <div class="login__socials">
            <button type="button" class="login__social login__social--icon-only" onClick={() => handleSocialLogin("google")}>
            ...
            <button type="button" class="login__social login__social--icon-only" onClick={() => handleSocialLogin("github")}>
            ...
            <button type="button" class="login__social login__social--icon-only" onClick={() => handleSocialLogin("twitter")}>
