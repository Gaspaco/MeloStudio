...
export function animateIntro(refs: {
  ...
  if (!hasLoaded) {
    ...
    intro
      .from(meloChars, { yPercent: 120, stagger: 0.08, duration: 0.7, ease: "power4.out" }, 0)
      .from(studioChars, { xPercent: 80, opacity: 0, stagger: 0.05, duration: 0.6, ease: "power3.out" }, 0.4)
  ...
  intro
    ...
    .fromTo(refs.scrollIndRef, { scaleY: 0 }, { scaleY: 1, duration: 0.8, transformOrigin: "top" }, 2.1);
